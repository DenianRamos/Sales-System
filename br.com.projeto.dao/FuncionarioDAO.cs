        ...
        public bool efetuaLogin(string email, string senha)
        {
            try
            {
                ...
                if (reader.Read())
                {
                    ...
                    MessageBox.Show("Login realizado, Bem vindo " + nome);
                    FrmMenu menu = new FrmMenu();

                    
                    if (nivel.Equals("Administrador", StringComparison.OrdinalIgnoreCase))
                    {
                        menu.Show();
                    }
                    else if (nivel.Equals("Vendedor", StringComparison.OrdinalIgnoreCase))
                    {
                        menu.MenuProdutos.Enabled = false;
                        menu.MenuHistoricoVendas.Enabled = false;
                        menu.Show();
